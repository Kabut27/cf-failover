...
MAIN_KEYBOARD_JSON='{"keyboard":[["➕ Ongeza Node","➖ Ondoa Node"],["🎯 Weka Priority","📋 Orodha Nodes"],["🌐 Ongeza Domain","🗑️ Ondoa Domain"],["📄 Orodha Domains","🔄 Refresh"],["ℹ️ Msaada"]],"resize_keyboard":true,"is_persistent":true}'
...
# kitufe alichobonyeza awali (mfano baada ya "➕ Ongeza Node").
