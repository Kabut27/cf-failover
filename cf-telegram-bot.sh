...
# NODE_PRIORITY/TARGET_RECORDS HAZIHITAJIKI hapa - zinasomwa moja kwa
# moja kutoka Cloudflare (get_shared_config, chini). Zikiwa tupu bado
# (usakinishaji mpya), bot itakuruhusu kuziongeza kupitia menu.
...
handle_menu_button() {
  ...
  case "$text" in
    ...
    "🧹 Safisha Marudio") handle_cleanup ;;
